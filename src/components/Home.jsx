...
import { ERC721, ERC721ABI, ERC1155, ERC1155ABI } from '../utils/contracts'
...
export default class Home extends React.Component{
    ...
    bep1155 = async () => {
        ...
        if(connected && uploaded && name && description && additional){
            try{
            let contract = new ethers.Contract(ERC1155,ERC1155ABI,signer)
    ...
    bep721 = async () => {
        ...
        if(connected && uploaded && name && description && additional){
            try{
            let contract = new ethers.Contract(ERC721,ERC721ABI,signer)
            ...
            let tx = await contract["mint(string)"](`${name}`,{ value: 100_000_000_000 });
